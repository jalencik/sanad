export default {
  ...
  landing: {
    ...
    pipeline: {
      ...
      explainBody:
        "AI summarizes the document's main point in its original language and in English — so nothing gets lost in translation.",
    },
    ...
    footerStack: 'Built with FastAPI, Tesseract OCR, Groq, and Vue.',
  },
  auth: {
    emailLabel: 'Email',
