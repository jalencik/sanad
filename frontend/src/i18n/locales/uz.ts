export default {
  ...
  landing: {
    ...
    pipeline: {
      ...
      explainBody:
        "AI hujjatning asosiy mazmunini asl tilida va ingliz tilida qisqacha bayon qiladi — hech narsa tarjimada yo'qolmaydi.",
    },
    ...
    footerStack: "FastAPI, Tesseract OCR, Groq va Vue asosida yaratilgan.",
  },
  auth: {
